...
export const DETAIL_MENU = Object.freeze([{ id: "parameters", label: "Параметры", labelEn: "Parameters" }, { id: "reference", label: "Подсказка", labelEn: "Reference" }, { id: "activity", label: "Активность", labelEn: "Activity", mode: "director" }, { id: "console", label: "Консоль", labelEn: "Console", mode: "director" }]);
