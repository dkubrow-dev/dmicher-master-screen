...
export function renderObjectInformation(document, definitions, draft) {
...
export function readObjectInformation(element, draft) {
  return { ...draft, groupId: formValue(element, "object-group") || null, tags: splitTags(formValue(element, "object-tags")),
    notes: formValue(element, "object-notes"), playerCharacter: draft.type === "Token" && element.querySelector('[name="object-player-character"]')?.checked === true };
}
