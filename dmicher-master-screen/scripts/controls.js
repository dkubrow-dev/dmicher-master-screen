...
export function buildControls(controller) {
  ...
  const definitions = [
    ...
    ["start", stopped ? t("Продолжить всё", "Resume all") : t("Старт", "Start"), "fa-solid fa-play", () => controller.startAll()],
    stopped ? ["reset", t("Вернуть в исходное состояние", "Restore initial state"), "fa-solid fa-rotate-left", () => controller.restoreAllInitial()]
